...
namespace _02_MusicApp.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Artists",
                columns: new[] { "Id", "CountryId", "First_Name", "Last_Name" },
                values: new object[,]
                {
                    { 1, 1, "Vitaliy", "Labenskyi" },
                    { 2, 3, "Brock", "Lasnar" },
                    { 3, 2, "Robert", "Puszulicki" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Albums",
                columns: new[] { "Id", "ArtistId", "GenreId", "Name", "ReleaseDate" },
                values: new object[,]
                {
                    { 1, 1, 3, "Black nights", new DateTime(2020, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, 1, "Rocky one", new DateTime(2019, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 3, 2, "Package lost", new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
